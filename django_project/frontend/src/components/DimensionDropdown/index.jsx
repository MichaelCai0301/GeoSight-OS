...
const DimensionDropdownComponent = ({ dimensionOptions, dimensionsSelected, onDimensionsChange }) => {
...
const SingleDimensionDropdown = ({ dimension, options, selectedValues, onSelectionChange }) => {
...
export default DimensionDropdownComponent;